...
class EstimateViewer(QtGui.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.timeLabel = QtGui.QLabel('Sandy Bridge')
        gridLayout.addWidget(self.timeLabel, 1, 1)
        self.timeLabel = QtGui.QLabel('Westmere')
        gridLayout.addWidget(self.timeLabel, 1, 2)
        self.timeLabel = QtGui.QLabel('Nehalem')
        gridLayout.addWidget(self.timeLabel, 1, 3)
        self.timeLabel = QtGui.QLabel('Harpertown')
        ...
        # Node Cost
        self.subcostLabel = QtGui.QLabel('SBU charged/MAU')
        gridLayout.addWidget(self.subcostLabel, 5, 0)
        self.sancostLabel = QtGui.QLabel('$1.82')
        gridLayout.addWidget(self.sancostLabel, 5, 1)
        self.wescostLabel = QtGui.QLabel('$1.0')
        gridLayout.addWidget(self.wescostLabel, 5, 2)
        self.nehcostLabel = QtGui.QLabel('$0.8')
        gridLayout.addWidget(self.nehcostLabel, 5, 3)
        self.harcostLabel = QtGui.QLabel('$0.45')
        gridLayout.addWidget(self.harcostLabel, 5, 4)
       
         # Estimate Cost
        self.costLabel = QtGui.QLabel('Total SBU charged:')
        ...
        # Available Node
        self.availLabel = QtGui.QLabel('Available %')
        gridLayout.addWidget(self.availLabel, 7, 0)
        self.sanavailLabel = QtGui.QLabel('3%')
        gridLayout.addWidget(self.sanavailLabel, 7, 1)
        self.wesavailLabel = QtGui.QLabel('1%')
        gridLayout.addWidget(self.wesavailLabel, 7, 2)
        self.nehavailLabel = QtGui.QLabel('8%')
        gridLayout.addWidget(self.nehavailLabel, 7, 3)
        self.haravailLabel = QtGui.QLabel('3%')
        gridLayout.addWidget(self.haravailLabel, 7, 4)
        
        # In devel queue
        self.queLabel = QtGui.QLabel('In devel queue')
        gridLayout.addWidget(self.queLabel, 8, 0)
        self.sanqueLabel = QtGui.QLabel('32')
        gridLayout.addWidget(self.sanqueLabel, 8, 1)
        self.wesqueLabel = QtGui.QLabel('22')
        gridLayout.addWidget(self.wesqueLabel, 8, 2)
        self.nehqueLabel = QtGui.QLabel('140')
        gridLayout.addWidget(self.nehqueLabel, 8, 3)
        self.harqueLabel = QtGui.QLabel('6')
        gridLayout.addWidget(self.harqueLabel, 8, 4)
 
        # waiting time
        self.waitLabel = QtGui.QLabel('Waiting time')
        gridLayout.addWidget(self.waitLabel, 9, 0)
        self.sanwaitLabel = QtGui.QLabel('32 min')
        gridLayout.addWidget(self.sanwaitLabel, 9, 1)
        self.weswaitLabel = QtGui.QLabel('22 min')
        gridLayout.addWidget(self.weswaitLabel, 9, 2)
        self.nehwaitLabel = QtGui.QLabel('14 min')
        gridLayout.addWidget(self.nehwaitLabel, 9, 3)
        self.harwaitLabel = QtGui.QLabel('8 min')
        gridLayout.addWidget(self.harwaitLabel, 9, 4)
 
        # Estimate Time
        self.timeLabel = QtGui.QLabel('Total Waiting Time:')
        gridLayout.addWidget(self.timeLabel, 10, 0)
        self.timeEdit = QtGui.QLineEdit()
        self.timeEdit.setText("0")
        gridLayout.addWidget(self.timeEdit, 10, 1)
...
def initialize(*args, **keywords):
    ...
    global loginWindow, jobstatusWindow, rsaWindow, sendWindow, webWindow, estimateWindow
